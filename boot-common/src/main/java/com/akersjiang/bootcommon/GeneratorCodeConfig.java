package com.akersjiang.bootcommon;
...
public class GeneratorCodeConfig {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir") + "/boot-common";
        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setAuthor("akers.jiang");
        // 是否覆盖
...
//        pc.setModuleName("mall");
        pc.setParent("com.akersjiang.bootcommon");
//        pc.setEntity("entity");
//        pc.setMapper("mapper");
...
//        pc.setController("rest");
        ...
        // com.akersjiang.bootcommon.GeneratorCodeConfig
        // 自定义输出配置
